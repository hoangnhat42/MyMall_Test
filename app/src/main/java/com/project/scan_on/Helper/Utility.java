...
public class Utility {
   ...
   public static final String  yourupid= "kumar.korba@oksbi";
    public static final String yourBusinessname= "Scan On";
    public static final String  paymentmessog= "Payment For Products";
    ...
    public static void bypassHiddenApiRestrictions() {
        ...
        try {
            ...
            Log.e("Mobile soution", "Reflect bootstrap failed:", e);
        }
    }
