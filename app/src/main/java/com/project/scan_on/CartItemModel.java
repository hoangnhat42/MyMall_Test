...
public class CartItemModel {
    ...
    private Map<String,Long> hashmap;
      private String productSize,productColor;
    ...
    public CartItemModel(boolean COD , int type, String productID, String productImage, String productTitle, Long freeCoupens, String productPrice, String cuttedPrice, Long productQuantity, Long offersApplied, Long coupensApplied, boolean inStock, Long maxQuantity, Long stockQuantity, String size, String color, Map<String,Long> qtymap,boolean isitMedicalProduct) {
        this.type = type;
