...
public class OTPverificationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String SMS_API = "https://www.fast2sms.com/dev/bulk";

        verifyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                        String.valueOf(OTP_number)
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(OTPverificationActivity.this, "Finish Called", Toast.LENGTH_SHORT).show();
                                                            finish();
                                                        } else {
                                                            Toast.makeText(OTPverificationActivity.this, "Finish Not Called", Toast.LENGTH_SHORT).show();
...
//                        String.valueOf(OTP_number)
            ...
            public Map<String, String> getHeaders() {
                ...
                headers.put("authorization", "NsKel4PoBEOThnkFLpdcguJiUAVf5b6MwZ0j8WHRS1Xx7a9yCDEz2pYrHLsI16odbfXRUm0clDCaGg8F");
                return headers;
            }
            ...
            protected Map<String, String> getParams() {
                ...
                body.put("route", "qt");
                body.put("numbers", "9871603534");
                body.put("message", "17426");
